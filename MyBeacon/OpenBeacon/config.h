...
// #define GSM_EN   10 // PB2
 ...
 #define CHUTE_PIN 5 // PD5 нога 9, ШИМ
  ...
  #define  nSEL_on (PORTD |= (1<<4)) //D4
  #define  nSEL_off PORTD &= 0xEF    //D4  4, mega's pin 2
  #define  SCK_on   PORTD |=  _BV(7)    //D7
  #define  SCK_off  PORTD &= ~_BV(7)    //D7
  #define  SDI_on   PORTB |=  _BV(0)    //B0
  #define  SDI_off  PORTB &= ~_BV(0)    //B0
  #define  SDO_read ((PINB & _BV(1)) != 0) //B1
  #define SDO_pin 9
  #define SDI_pin 8
  #define SCLK_pin 7
  #define IRQ_pin 2 // INT0
